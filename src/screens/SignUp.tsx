    ...
    <div className="min-h-screen flex flex-col items-center justify-center relative overflow-hidden" style={{ backgroundColor: '#4A4D5E' }}>
      ...
      <div className="relative z-10 flex flex-col items-center w-full px-4">
        ...
        <div className="bg-white rounded-2xl shadow-xl p-8 w-full max-w-md">
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            <div>
              ...
              <input
                ...
                className="w-full border border-gray-300 rounded-lg px-3 py-2.5 text-[14px] text-gray-900 placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:border-transparent"
              />
            </div>
            ...
            <div>
              ...
              <div className="relative">
                <input
                  ...
                  className="w-full border border-gray-300 rounded-lg px-3 py-2.5 pr-10 text-[14px] text-gray-900 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:border-transparent"
                />
                <button
                  type="button"
            ...
            <div className="flex items-start gap-3">
              ...
              />
              <label htmlFor="agree" className="text-[12px] text-gray-500 leading-relaxed cursor-pointer">
                By checking this box, I agree to receive updates, insights and offers from SafetyCulture and its affiliates by email and phone to the above contact information. I understand I can withdraw my consent.
              </label>
            </div>

            <button
              type="submit"
              className="w-full text-[15px] text-white font-semibold rounded-lg py-3 transition-colors mt-2"
          ...
          <p className="text-[13px] text-gray-700 text-center mt-3 font-medium">
